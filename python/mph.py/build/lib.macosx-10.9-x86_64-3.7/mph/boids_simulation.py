...
class Flock:
    def __init__(self, count=500, width=500, height=250, sep=1, ali=1, coh=1, seprad=1, alirad=1, cohrad=1):
        self.width = width
        self.height = height
...
def run_simulation(n,
    ...
    flock = Flock(n, width, height, sep, ali, coh, seprad, alirad, cohrad)
